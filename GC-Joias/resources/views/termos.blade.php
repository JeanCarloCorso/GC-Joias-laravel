...
@section('content')
    ...
    <ol>
        <li><span style="color: rgb(68, 68, 68);">Os materiais no site da GC Jóias são fornecidos 'como estão'.
        ...
        <li><span style="color: rgb(68, 68, 68);">Além disso, o GC Jóias não garante ou faz qualquer
