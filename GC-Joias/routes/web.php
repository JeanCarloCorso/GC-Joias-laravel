...
Route::post('/login/edit/{id}', [AreaRestritaController::class, 'EditarProduto'])->name('ar.editarProduto');
Route::post('/login/saveedit/{id}', [AreaRestritaController::class, 'SalvarEdicaoProduto'])->name('ar.salvarEdicaoProduto');
